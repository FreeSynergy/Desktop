    ...
    rsx! {
        div {
            ...
            if *confirm_remove.read() {
                div {
                    ...
                    div {
                        ...
                        p {
                            style: "font-size: 15px; font-weight: 600; color: var(--fsn-color-text-primary); margin: 0;",
                        ...
                        div {
                            ...
                            button {
                                style: "padding: 7px 16px; border-radius: var(--fsn-radius-md); \
                                        border: 1px solid var(--fsn-color-border-default); \
                            ...
                            button {
                                style: "padding: 7px 16px; border-radius: var(--fsn-radius-md); \
                                        border: none; background: var(--fsn-color-error, #ef4444); \
            ...
            div {
                ...
                // Details button
                button {
                    style: "flex: 1; padding: 8px; background: var(--fsn-color-bg-overlay); \
                            border: 1px solid var(--fsn-color-border-default); \
                ...
                if package.installed_by.is_some() {
                    ...
                    if package.update_available {
                        // Update button
                        button {
                            style: "flex: 1; padding: 8px; background: var(--fsn-color-warning, #f59e0b); \
                        ...
                        div {
                            ...
                            button {
                                style: "flex: 1; padding: 8px 10px; background: var(--fsn-color-primary); \
                                        color: white; border: none; \
                                        border-radius: var(--fsn-radius-md) 0 0 var(--fsn-radius-md); \
                                        cursor: pointer; font-size: 13px;",
                                onclick: move |evt: MouseEvent| {
                                    evt.stop_propagation();
                                    if let Some(ref h) = on_install { h.call(()); }
                                },
                                {fsn_i18n::t("actions.reinstall")}
                            }

                            // Dropdown toggle
                            button {
                                style: "padding: 8px 10px; background: var(--fsn-color-primary); \
                                        color: white; border: none; border-left: 1px solid rgba(255,255,255,0.2); \
                                        border-radius: 0 var(--fsn-radius-md) var(--fsn-radius-md) 0; \
                    ...
                    // Install button
                    button {
                        style: "flex: 1; padding: 8px; background: var(--fsn-color-primary); \
                                color: white; border: none; \
                                border-radius: var(--fsn-radius-md); cursor: pointer; font-size: 13px;",
                        onclick: move |evt: MouseEvent| {
                            evt.stop_propagation();
