...
pub fn ResourceBrowser() -> Element {
    ...
    rsx! {
        div {
            ...
            div {
                style: "width: 240px; border-right: 1px solid var(--fsn-color-border-default); \
                ...
                div {
                    ...
                    match *git_access.read() {
                        ...
                        Some(true) => rsx! {
                            div {
                                style: "font-size: 12px; color: var(--fsn-color-success, #22c55e); \
                                        margin-bottom: 8px;",
                                "✓ Store write access confirmed"
                            }
                            p { style: "font-size: 12px; color: var(--fsn-color-text-muted);",
                        ...
                        if let Some(fp) = &pkg.file_path {
                            div {
                                style: "font-size: 11px; color: var(--fsn-color-text-muted); \
                                        margin-bottom: 8px; font-family: var(--fsn-font-mono, monospace);",
                                "{fp}"
                            }
                        }
                        ...
                        if pkg.file_path.is_none() {
                            div {
                                style: "flex: 1; display: flex; align-items: center; \
                                        ...
                                        border-radius: var(--fsn-radius-md); padding: 32px;",
                            ...
                            textarea {
                                style: "flex: 1; width: 100%; padding: 10px 12px; \
                                        font-family: var(--fsn-font-mono, monospace); \
    ...
    rsx! {
        div {
            style: "padding: 10px 14px; cursor: pointer; border-bottom: 1px solid \
                    var(--fsn-color-border-default); {bg}",
            onclick: {
                let p = pkg.clone();
