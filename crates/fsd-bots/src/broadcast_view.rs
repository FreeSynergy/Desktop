    ...
    rsx! {
        div { style: "display: flex; flex-direction: column; gap: 16px;",
            ...
            div {
                label {
                    style: "display: block; font-size: 12px; font-weight: 600; \
                            color: var(--fsn-color-text-muted); margin-bottom: 8px; \
                            text-transform: uppercase; letter-spacing: 0.06em;",
                    "Send to"
                }
            ...
            button {
                style: "align-self: flex-start; background: var(--fsn-color-primary); \
    ...
    rsx! {
        div {
            style: "display: flex; align-items: center; gap: 8px; font-size: 13px; \
                    color: var(--fsn-color-text-primary); padding: 4px 0;",
            span { style: "color: var(--fsn-color-primary);", "{check}" }
            span { style: "color: var(--fsn-color-text-muted); font-size: 11px;", "{target.platform}:" }
            span { "{target.name}" }
        }
    }
}
    ...
    rsx! {
        div {
            style: "display: flex; align-items: center; gap: 10px; font-size: 12px; \
                    color: var(--fsn-color-text-muted); padding: 5px 0; \
