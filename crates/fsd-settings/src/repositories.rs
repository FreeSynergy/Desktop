/// Repositories — manage configured package stores.
///
...
#[component]
pub fn RepositoriesSettings() -> Element {
        ...
        div {
            ...
            div {
                style: "display: flex; align-items: flex-start; justify-content: space-between; \
                        margin-bottom: 24px;",
                div {
                    h3 { style: "margin: 0;", {fsn_i18n::t("settings.repos.title")} }
                    p {
                        style: "margin: 4px 0 0; color: var(--fsn-color-text-muted); font-size: 13px;",
                        {fsn_i18n::t("settings.repos.description")}
                    }
                }
                button {
                    ...
                    {fsn_i18n::t("settings.repos.btn_add")}
                }
            }
            ...
            div {
                ...
                if items.is_empty() && *mode.read() == FormMode::Hidden {
                    div {
                        ...
                        {fsn_i18n::t("settings.repos.empty")}
                    }
                }
...
/// One repository row — read-only display with action buttons.
#[component]
fn RepoRow(
    entry: RepoEntry,
                ...
                div { style: "display: flex; align-items: center; gap: 8px; flex-wrap: wrap;",
                    ...
                    if entry.primary {
                        span {
                            ...
                            {fsn_i18n::t("settings.repos.badge_primary")}
                        }
                    }
                    if !entry.enabled {
                        span {
                            style: "font-size: 11px; color: var(--fsn-color-text-muted);",
                            {fsn_i18n::t("settings.repos.badge_disabled")}
                        }
                    }
                }
                div {
...
/// Inline add/edit form for a repository entry.
#[component]
fn RepoForm(
    entry: RepoEntry,
            ...
            div { style: "display: grid; grid-template-columns: 1fr 1fr; gap: 12px;",
                ...
                div {
                    label {
                        ...
                        {fsn_i18n::t("settings.repos.label_name")}
                    }
                    input {
                ...
                div {
                    label {
                        style: "display: block; font-size: 12px; color: var(--fsn-color-text-muted); margin-bottom: 4px;",
                        {fsn_i18n::t("settings.repos.label_url")}
                    }
                    input {
                        style: "width: 100%; padding: 7px 10px; border: 1px solid var(--fsn-color-border-default); \
                                border-radius: var(--fsn-radius-md); font-size: 13px; \
                ...
                div {
                    label {
                        style: "display: block; font-size: 12px; color: var(--fsn-color-text-muted); margin-bottom: 4px;",
                        {fsn_i18n::t("settings.repos.label_git_url")}
                    }
                    input {
                        style: "width: 100%; padding: 7px 10px; border: 1px solid var(--fsn-color-border-default); \
                                border-radius: var(--fsn-radius-md); font-size: 13px; \
                ...
                div {
                    label {
                        style: "display: block; font-size: 12px; color: var(--fsn-color-text-muted); margin-bottom: 4px;",
                        {fsn_i18n::t("settings.repos.label_local_path")}
                    }
                    input {
                        style: "width: 100%; padding: 7px 10px; border: 1px solid var(--fsn-color-border-default); \
                                border-radius: var(--fsn-radius-md); font-size: 13px; \
