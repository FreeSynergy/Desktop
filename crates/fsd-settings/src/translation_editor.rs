        ...
        div {
            ...
            div {
                ...
                if llm_available {
                    button {
                        style: format!(
                            "padding: 6px 14px; font-size: 12px; border-radius: var(--fsn-radius-sm); \
                             cursor: pointer; white-space: nowrap; font-weight: 500; \
                             border: 1px solid {}; background: {}; color: {};",
                            if *show_llm_panel.read() { "var(--fsn-color-primary)" } else { "var(--fsn-color-border-default)" },
                            if *show_llm_panel.read() { "rgba(77,139,245,0.15)" } else { "var(--fsn-color-bg-surface)" },
                            if *show_llm_panel.read() { "var(--fsn-color-primary)" } else { "var(--fsn-color-text-primary)" },
                        ),
                        onclick: move |_| {
                        ...
                        "🤖 "
                        {fsn_i18n::t("settings.language.editor.ai_translate")}
                    }
                }
            }
                ...
                div {
                    ...
                    div {
                        ...
                        span { style: "font-size: 13px; font-weight: 600;",
                            "🤖 "
                            {fsn_i18n::t("settings.language.editor.ai_panel_title")}
                        }
                        span {
                            style: "font-size: 11px; color: var(--fsn-color-text-muted); flex: 1;",
                            {fsn_i18n::t("settings.language.editor.ai_prompt_hint")}
                        }
                        ...
                        if !llm_proposals.read().is_empty() {
                            span {
                                ...
                                {fsn_i18n::t_with("settings.language.editor.ai_proposals",
                    ...
                    div { style: "display: flex; gap: 8px; align-items: flex-end; margin-bottom: 12px;",
                        textarea {
                            style: "flex: 1; padding: 8px 10px; font-size: 13px; \
                                    background: var(--fsn-color-bg-input, var(--fsn-color-bg-default)); \
                                    border: 1px solid var(--fsn-color-border-default); \
                                    border-radius: var(--fsn-radius-sm); \
                        ...
                        button {
                            style: format!(
                                "padding: 8px 18px; background: var(--fsn-color-primary); \
                                        ...
                                        match call_llm_service(&service, prompt).await {
                                            Ok(response) => {
                                                ...
                                                if proposals.is_empty() {
                                                    llm_error2.set(Some(
                                                        fsn_i18n::t("settings.language.editor.ai_no_proposals")
                                                    ));
                                                } else {
                            ...
                            if *llm_busy.read() {
                                {fsn_i18n::t("settings.language.editor.ai_thinking")}
                            } else {
                                {fsn_i18n::t("settings.language.editor.ai_send")}
                            }
                        }
                    }
                    ...
                    if let Some(err) = llm_error.read().as_ref() {
                        div {
                            style: "font-size: 12px; color: var(--fsn-color-error, #f87171); \
                                    margin-bottom: 8px;",
                            "{err}"
                        }
                    }
                        ...
                        div {
                            ...
                            div {
                                ...
                                button {
                                    ...
                                    {fsn_i18n::t("settings.language.editor.ai_accept_all")}
                                }
                            }
